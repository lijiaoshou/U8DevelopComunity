    ...
    public static class UFIDASms
    {
        ...
        public static void Send(string phone, string message)
        {
            ...
            while (index < message.Length)
            {
                ...
                string html = UFIDARequest.GetHtml(string.Format(smsUrl, phone, HttpUtility.UrlEncode(current, Encoding.GetEncoding("GBK")), Encoding.GetEncoding("GBK")));
                if (UFIDAJson.FromJson<SlSmsStatus>(html).status != "0000")
                {
