...
namespace U8.Framework.Web
{
    ...
    public static class U8Request
    {
        ...
        /// <returns></returns>
        public static string GetHtml(string url, Encoding encoding = null, int timeout = 10000, U8HttpActionType httpActionType = U8HttpActionType.Get, string postParameter = "", string UserAgent = "")
        {
            if (encoding == null)
            {
            ...
            try
            {
                ...
                if (httpActionType == U8HttpActionType.Post)
                {
                    request.Method = "POST";
