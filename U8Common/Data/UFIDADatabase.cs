...
namespace UFIDA.Framework.Data
{
    ...
    /// 数据库操作
    /// </summary>
    public static class UFIDADatabase
    {
        /// <summary>
        ...
        public static int ExecuteNonQuery(string connectionString, string sentence, DbParameter[] parameters = null, UFIDADatabaseType databaseType = UFIDADatabaseType.SqlServer)
        {
        ...
        /// <param name="databaseType">数据库类型</param>
        /// <returns>读取器</returns>
        public static DbDataReader ExecuteReader(string connectionString, string sentence, DbParameter[] parameters = null, UFIDADatabaseType databaseType = UFIDADatabaseType.SqlServer)
        {
            sentence = SqlDebug(sentence, parameters);
            DbProviderFactory factory = GetDbProviderFactory(databaseType);
        ...
        public static object ExecuteScalar(string connectionString, string sentence, DbParameter[] parameters = null, UFIDADatabaseType databaseType = UFIDADatabaseType.SqlServer)
        {
            sentence = SqlDebug(sentence, parameters);
            object result = null;
            DbProviderFactory factory = GetDbProviderFactory(databaseType);
        ...
        /// <param name="parameters">参数数组</param>
        /// <param name="databaseType">数据库类型</param>
        public static void Fill(string connectionString, string sentence, DataSet dataSet, DbParameter[] parameters = null, UFIDADatabaseType databaseType = UFIDADatabaseType.SqlServer)
        {
            sentence = SqlDebug(sentence, parameters);
            DbProviderFactory factory = GetDbProviderFactory(databaseType);
            DbConnection dbConnection = factory.CreateConnection();
        ...
        /// <param name="parameters">参数数组</param>
        /// <param name="databaseType">数据库类型</param>
        public static void Fill(string connectionString, string sentence, DataTable dataTable, DbParameter[] parameters = null, UFIDADatabaseType databaseType = UFIDADatabaseType.SqlServer)
        {
            sentence = SqlDebug(sentence, parameters);
            DbProviderFactory factory = GetDbProviderFactory(databaseType);
            DbConnection dbConnection = factory.CreateConnection();
        ...
        public static DbProviderFactory GetDbProviderFactory(UFIDADatabaseType databaseType = UFIDADatabaseType.SqlServer)
        {
            DbProviderFactory instance = null;
            switch (databaseType)
            {
                case UFIDADatabaseType.SqlServer:
                    instance = SqlClientFactory.Instance;
                    break;
                case UFIDADatabaseType.OleDb:
        ...
        private static string SqlDebug(string sql, IList<DbParameter> parameters)
        {
            ...
            bool sqlDebug = false;
            try { sqlDebug = UFIDAConfig.GetValue<bool>("SqlDebug"); }
            catch (Exception ex) { }
