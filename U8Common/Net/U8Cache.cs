...
namespace U8.Framework.Net
{
    ...
    /// .net缓存策略
    /// </summary>
    public class U8HttpCache : ICache
    {
        private static object syncObject = new object();
        /// <summary>
        /// 构造方法
        /// </summary>
        protected U8HttpCache() { }

        private static U8HttpCache instance;
        /// <summary>
        /// 
        /// </summary>
        public static U8HttpCache Current
        {
            get
            {
                if (instance == null)
    ...
    public class SlMemCached : ICache
    {
        ...
        /// 缓存客户端对象
        /// </summary>
        public U8MemcachedClient memcachedClient;
        /// <summary>
        /// 构造方法
        /// </summary>
        /// <param name="client"></param>
        public SlMemCached(U8MemcachedClient client)
        {
