...
namespace U8.Framework.Net
{
    ...
    /// Memcached操作
    /// </summary>
    public class U8MemcachedClient
    {
        ...
        public U8MemcachedClient(string pName, string memServer, int InitConnections = 3, int MinConnections = 3, int MaxConnections = 5, int SocketConnectTimeout = 1000, int SocketTimeout = 3000)
        {
