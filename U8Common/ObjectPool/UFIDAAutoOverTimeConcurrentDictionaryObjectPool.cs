...
namespace UFIDA.Framework.ObjectPool
{
    ...
    public class UFIDAAutoOverTimeConcurrentDictionaryObjectPool<TKey, TValue> : IDisposable where TValue : UFIDAAutoOverTimeConcurrentDictionaryObjectPoolValue
    {
        ...
        public UFIDAAutoOverTimeConcurrentDictionaryObjectPool(double overTimeInterval, double clearInterval)
        {
