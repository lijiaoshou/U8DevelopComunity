...
namespace U8.Framework.Business
{
    ...
    /// Cookie模型
    /// </summary>
    public struct U8CookieModelForCookieServer
    {   
        /// <summary>
        /// 主键
        /// </summary>
    ...
    public class U8CookieServer
    {
        ...
        public U8CookieServer(IPEndPoint point)
        {
            IpEndPoint = point;
        }
        ...
        /// <returns></returns>
        public void AddCookie(U8CookieModelForCookieServer[] cookielist)
        {
            ...
            U8Socket.Send(IpEndPoint, data, false, Encoding.GetEncoding("GBK"));
        }
        ...
        public void SetCookie(string keyname, string value, UInt32 time)
        {
            ...
            U8Socket.Send(IpEndPoint, data, true, Encoding.GetEncoding("GBK"));
        }
        ...
        /// <param name="cookielist"></param>
        /// <returns></returns>
        public void UpdateCookie(U8CookieModelForCookieServer[] cookielist)
        {
            if (cookielist.Length == 0 || cookielist.Length > 1024)
            {
                return;
            ...
            data = data.Substring(0, data.Length - 1) + "\n";
            U8Socket.Send(IpEndPoint, data, false, System.Text.Encoding.GetEncoding("GBK"));
        }
        ...
        public string QueryCookie()
        {
            ...
            data = U8Socket.Send(IpEndPoint, data, true, System.Text.Encoding.GetEncoding("GBK"));
