...
namespace UFIDA.Framework.Text
{
    ...
    /// SlBase64处理
    /// </summary>
    public static class UFIDABase64
    {
        /// <summary>
        /// 转换为Base64
        /// </summary>
        ...
        {
            return UFIDAEncoding.Default.GetBytes(Convert.ToBase64String(datas));
        }
        ...
        {
            string input = UFIDAEncoding.Default.GetString(Base64Data);
    ...
    /// <returns>原形式</returns>
        ...
        public static string FromBase64String(byte[] Base64Data)
        {
            ...
            return UFIDAEncoding.Default.GetString(outputb);
        }
        /// <summary>
        /// 由Base64数据转换为原形式
        /// </summary>
